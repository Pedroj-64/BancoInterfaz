...
import javafx.scene.control.Alert.AlertType;
 ...
 public class ActulizarDatosViewController {
     ...
     @FXML
     void actulizarUsuario(ActionEvent event) {
        ...
        if(controller.actulizarUsuario(id, nombre, password, correo, direccion)){
            ...
            txtCorreo.clear();
            txtDireccion.clear();
            App.showAlertAndRedirect("Éxito", "Datos actualizados correctamente", AlertType.INFORMATION, "panelCliente.fxml", 400, 400);
        };
